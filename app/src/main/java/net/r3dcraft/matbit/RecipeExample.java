...
public final class RecipeExample {
    ...
    public static Recipe recipeExample1 () {
        ...
        recipeData.addRating(new Rating("testuser2", 2, DateTime.nowString()));
        recipeData.addRating(new Rating("testuser3", 4, DateTime.nowString()));
        recipeData.addRating(new Rating("testuser4", 1, DateTime.nowString()));
        recipeData.addRating(new Rating("testuser5", 5, DateTime.nowString()));
    ...
    public static Recipe recipeExample2 () {
        ...
        recipeData.addRating(new Rating("testuser1", 1, DateTime.nowString()));
        recipeData.addRating(new Rating("testuser3", 1, DateTime.nowString()));
        recipeData.addRating(new Rating("testuser4", 4, DateTime.nowString()));
        recipeData.addRating(new Rating("testuser5", 2, DateTime.nowString()));
